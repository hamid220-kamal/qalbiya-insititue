      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#F9E8EC] border border-[#78122B]/20 text-xs font-mono font-bold tracking-widest text-[#78122B] uppercase shadow-2xs">
            <Compass className="w-3.5 h-3.5 text-[#78122B]" />
          ...
          <div className="p-6 rounded-2xl bg-white border border-[#E8DDD9] shadow-md max-w-2xl mx-auto text-center relative overflow-hidden">
            ...
            <span className="block text-xs text-[#A37B24] font-mono mt-3 font-bold uppercase tracking-widest">Prophet Muhammad ﷺ [Sahih Bukhari & Muslim]</span>
          </div>
        </motion.div>
        ...
        <div className="space-y-6">
          <div className="text-center max-w-xl mx-auto space-y-1">
            <h3 className="font-serif text-2xl font-bold text-[#78122B]">Explore Each Sacred Pillar</h3>
            <p className="text-xs text-[#5C4D50]">Click any pillar card below to uncover its spiritual wisdom and daily practice recommendations.</p>
          </div>
              ...
              return (
                <motion.div 
                  ...
                  className={`rounded-3xl border transition-all duration-300 overflow-hidden ${
                    isSelected 
                      ? 'border-[#78122B] bg-white shadow-xl ring-1 ring-[#78122B]/20' 
                      : 'border-[#E8DDD9] bg-white hover:bg-[#FDFBF7] hover:border-[#78122B]/40 shadow-2xs'
                  }`}
                >
                  <button
                  ...
                  >
                    <div className="flex items-center space-x-5 sm:space-x-8">
                      {/* Number Bullet */}
                      <span className={`w-12 h-12 rounded-2xl flex items-center justify-center text-base font-mono font-bold shrink-0 transition-all duration-300 shadow-xs ${
                        isSelected ? 'bg-[#78122B] text-white scale-105' : 'bg-[#F9E8EC] border border-[#78122B]/20 text-[#78122B]'
                      }`}>
                        0{pillar.id}
                      </span>
                      <div>
                        <div className="flex flex-wrap items-baseline gap-3">
                          <span className="font-serif font-bold text-xl sm:text-2xl text-[#78122B]">{pillar.name}</span>
                          <span className="text-sm sm:text-base text-[#630E23] font-medium font-serif italic">({pillar.english})</span>
                        </div>
                        <span className="text-xs font-mono tracking-widest text-[#5C4D50] uppercase flex items-center gap-1.5 mt-1 font-bold">
                          <IconComp className="w-3.5 h-3.5 text-[#78122B]" /> Pillar {pillar.id} of Islam
                        </span>
                      </div>
                    </div>

                    <div className="flex items-center space-x-6">
                      <span className="font-serif text-2xl sm:text-4xl text-[#78122B] font-bold opacity-90 hidden md:inline">
                        {pillar.arabic}
                      </span>
                      <div className={`p-2.5 rounded-full transition-all duration-300 ${isSelected ? 'bg-[#78122B] text-white rotate-90 shadow-md' : 'bg-[#FAF8F5] border border-[#E8DDD9] text-[#5C4D50] hover:text-[#78122B]'}`}>
                  ...
                  <AnimatePresence initial={false}>
                    {isSelected && (
                      ...
                      >
                        <div className="px-6 sm:px-8 pb-8 pt-4 space-y-6 text-sm text-[#5C4D50] border-t border-[#E8DDD9] bg-[#FAF8F5]/80">
                          
                          {/* Core Description & Significance */}
                          <div className="space-y-3 p-5 rounded-2xl bg-white border border-[#E8DDD9] border-l-4 border-l-[#78122B] shadow-2xs">
                            <span className="text-[#78122B] font-mono font-bold uppercase tracking-wider block text-xs flex items-center gap-1.5">
                              <Sparkles className="w-3.5 h-3.5 shrink-0 text-[#78122B]" /> Significance & Core Meaning
                            </span>
                            <p className="leading-relaxed font-serif text-base sm:text-lg text-[#23181A] font-semibold">
                              {pillar.significance || pillar.desc}
                            </p>
                          </div>

                          {/* Spiritual Reflection Block */}
                          <div className="p-6 rounded-2xl bg-[#F9E8EC] border border-[#78122B]/20 shadow-2xs relative overflow-hidden space-y-2">
                            <div className="flex items-center gap-2 text-[#78122B] font-mono font-bold uppercase tracking-widest text-xs">
                              <Quote className="w-4 h-4 text-[#78122B] shrink-0" />
                              <span>Spiritual Reflection</span>
                            </div>
                            <p className="font-serif text-sm sm:text-base text-[#23181A] italic leading-relaxed pl-6 border-l-2 border-[#78122B]/60 font-medium">
                              "{pillar.reflection}"
                            </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
                            ...
                            <div className="p-5 rounded-2xl bg-white border border-[#E8DDD9] space-y-2 shadow-2xs">
                              <span className="text-[#2E6B38] font-mono font-bold uppercase tracking-wider block text-xs flex items-center gap-1.5">
                                <CheckCircle2 className="w-3.5 h-3.5 shrink-0 text-[#2E6B38]" /> Actionable Daily Practice
                              </span>
                              <p className="text-xs sm:text-sm text-[#5C4D50] leading-relaxed font-serif font-medium">
                                {pillar.practice}
                              </p>
                            </div>
                            ...
                            <div className="p-5 rounded-2xl bg-white border border-[#E8DDD9] space-y-2 shadow-2xs">
                              <span className="text-[#78122B] font-mono font-bold uppercase tracking-wider block text-xs flex items-center gap-1.5">
                                <Book className="w-3.5 h-3.5 shrink-0 text-[#78122B]" /> How We Teach This in Academy
                              </span>
                              <p className="text-xs sm:text-sm text-[#5C4D50] leading-relaxed font-serif font-medium">
                          ...
                          <div className="pt-2 flex justify-end">
                            {onNavigate && (
                              <button
                                ...
                                className="inline-flex items-center space-x-2 text-xs font-bold uppercase tracking-wider text-[#78122B] hover:text-[#630E23] cursor-pointer"
                              >
        ...
        <motion.div 
          ...
          className="mt-16 p-8 sm:p-12 rounded-3xl bg-[#78122B] border border-[#630E23] text-center space-y-6 shadow-xl relative overflow-hidden"
        >
            ...
            {onNavigate && (
              <>
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3.5 rounded-xl border border-white/40 bg-white/10 text-white text-xs font-bold uppercase tracking-wider hover:bg-white/20 transition-colors shadow-md cursor-pointer"
                >
